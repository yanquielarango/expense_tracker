...
const inputFieldStyle = tva({
  base: 'flex-1 text-black py-0 px-3 placeholder:text-red-300  placeholder:text-base h-full ios:leading-[0px] web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
...
const CustomInput = React.forwardRef<React.ElementRef<typeof UIInput>, IInputProps>(
...
export { CustomInput, InputField, InputIcon, InputSlot };
