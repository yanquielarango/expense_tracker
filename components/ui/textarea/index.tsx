...
const textareaStyle = tva({
  base: 'w-full h-[100px] border border-background-300 rounded-xl data-[hover=true]:border-outline-400 data-[focus=true]:border-background-300 data-[focus=true]:border-2 data-[focus=true]:data-[hover=true]:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:bg-background-50 data-[disabled=true]:data-[hover=true]:border-background-300',
