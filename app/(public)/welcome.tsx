  ...
  return (
    <SafeAreaView className="bg-white flex-1 ">
      ...
      <VStack className="ml-4 ">
        <Image source={require('@/assets/images/bg.png')} className=" w-full h-[350px] " alt="welcome" />
      </VStack>
      ...
      <Box className="mt-10 items-center px-4 ">
        <TouchableOpacity className="bg-[#673ab7] w-full p-3  rounded-xl" onPress={() => router.replace('/sign-up')}>
