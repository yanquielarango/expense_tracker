  ...
  return (
    <SafeAreaView className="bg-white flex-1   ">
      ...
      <VStack className="items-center" >
        <Box  className="mt-10">
          <Text className="text-black font-JakartaBold text-4xl" >Always take control</Text>
        </Box>
        <Box className="">
          <Text className="text-black text-4xl font-JakartaBold" >of your finances</Text>
        </Box>
        <Box className="mt-5">
          <Text className='text-typography-600 font-JakartaSemiBold text-lg' >Finances must be arranged to set a better </Text>
          <Text className='text-typography-600 font-JakartaSemiBold text-center text-lg' >lifestyle in future </Text>
        </Box>
      </VStack>
